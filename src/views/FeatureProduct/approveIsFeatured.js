...
EnhancedTableToolbar.propTypes = {
  ...
  export class Featured extends Component {
    ...
    showItemList = () => {
		axios
			.get(process.env.REACT_APP_API + "/featured/all-appliedFeatured")
			.then((res) => {
    ...
    onRowDelete = ( id, btntext )=>{
      ...
      .then((res) => {
        ...
        if(this.state.btnText === "Panding"){
            this.setState({
                isOpen : true,
                message: "Item Activated as Featured", 
                type : "success"
              })
        }
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.storeID.store.storeName}</TableCell>
                      <TableCell align="right">{row.storeID.phone === undefined ? "" :row.storeID.phone}</TableCell>
                      <TableCell align="right">{row.storeID.email === undefined ? "":row.storeID.email}</TableCell>
                    ...
                    onClick={ () => {this.deleteItem(row._id, (row.isFeatured === true? deleteBtnText="Active": deleteBtnText ="Panding"))}}
                   
  color = "primary"> {(row.isFeatured === true? "Active":"Panding")} </ActionButton>
